...
\begin{document}
\slugger{sisc}{2014}{xx}{x}{Axxx--Axxx}
\maketitle
...
% 62P35 = Statistics, Applications to Physics
% 65C05 = Numerical Analysis, Monte carlo methods
% 65C10 = Numerical Analysis, Random number generation
% 65C35 = Numerical Analysis, Stochastic particle methods

\pagestyle{myheadings}
\thispagestyle{plain}
\markboth{PAUL~K. ROMANO}{RANDOM VARIATE GENERATION FROM THE MADLAND-NIX
  SPECTRUM}
...
\eqref{eq:evaporation} over the temperature distribution in \eqref{eq:triangle}:
\begin{equation}
...
\begin{figure}[htbp]
  \centering \includegraphics[width=3.5in]{../images/spectrum-semilogy.eps}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=3.5in]{../images/spectrum-loglog.eps}
  \caption{Energy distribution of random variates generated using
    \autoref{alg:madland-nix} compared to analytical predictions of the
